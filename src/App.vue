<template>
  <div id="app">
    <!-- <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="/">Barks and Brews</a>
      <button
        ...
        <div class="row">
          <div class="col-sm-7 col-xs-12">
            ...
            <p class="text-muted pt-1 pb-3">
              Barks and Brews allows you to find local dog friendly breweries in your area. Whether you're looking for
              outdoor or dining options, Barks and Brews will help you find a great place that you and your pup will
              enjoy!
            </p>
            <ul class="list-unstyled text-muted">
              <li class="mb-3">
                <i class="fas fa-phone-alt mr-3" aria-hidden="true"></i>
                <a class="text-muted" href="tel:(800-123-1234)">(800) 123-1234</a>
              </li>
              <li class="mb-3">
                <i class="fas fa-envelope mr-3" aria-hidden="true"></i>
                <a class="text-muted" href="mailto:barksandbrews@example.com">barksandbrews@example.com</a>
              </li>
            </ul>
          </div>
        ...
        <div class="row pb-md-6">
          ...
          <div class="col-sm-5 col-xs-12 d-flex align-items-center">
            <div class="ml-md-auto mx-auto mx-md-0 mt-3 mb-5 my-md-0">
              <a
                class="icon-sm icon-default icon-border hover-bg-primary rounded-circle ml-2"
